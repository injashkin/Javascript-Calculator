        ...
        switch (symbol) {
            ...
            case operator:
                setAll({
                    ...
                    ? stateAll.allVal + '-' : /[-]$/.test(stateAll.allVal) && symbol === '-' ? stateAll.allVal.slice(0, -1) + '+' : /[x/+-]$/.test(stateAll.allVal) && symbol !== '-' ? stateAll.allVal.slice(0, -1) + symbol //если какой-нибудь оператор присутствует, то удаляем его и добавляем в конец выражения вновь введеннный оператор
